...
# Chan grid
    ...
    rb_ch_1.grid(row= 2, column= 0, 
                #  padx= 5, pady= 5
                 )
    rb_ch_2.grid(row= 3, column= 0, 
                #  padx= 5, pady= 5
                 ) 
    rb_ch_3.grid(row= 4, column= 0, 
                #  padx= 5, pady= 5
                 ) 
    rb_ch_1_2.grid(row= 2, column= 1, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_2_1.grid(row= 3, column= 1, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_1_3.grid(row= 4, column= 1, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_3_1.grid(row= 5, column= 1, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_1_1.grid(row= 2, column= 2, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_2_2.grid(row= 3, column= 2, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_3_3.grid(row= 4, column= 2, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_2_3.grid(row= 2, column= 3, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
    rb_ch_3_2.grid(row= 3, column= 3, sticky= 'w',
                #    padx= 5, pady= 5
                   ) 
